...
Reserved namespace for the Rocket adapter of the Guard ecosystem. Currently a scaffold: `src/lib.rs` is the stock 14-line `cargo new` stub, `Cargo.toml` has no dependencies, and no CI compiles anything.
